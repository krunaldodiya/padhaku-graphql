...
<body>
    ...
    <p>Pauzr built the Sawaal Bemisaal app as a Free app. This SERVICE is provided by Pauzr at no cost and is
        intended for
        use as is.</p>
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
        accessible at
        Sawaal Bemisaal unless otherwise defined in this Privacy Policy.</p>
    <p><strong>Information Collection and Use</strong></p>
    <p>For a better experience, while using our Service, we may require you to provide us with certain personally
        identifiable information, including but not limited to Mobile Number,Contact,Name,Email. The information
        that we
    ...
    <p>The app requests below permissions from the user -</p>
    <ul>
        <li>CAMERA</li>
        <li>READ_CONTACTS</li>
    </ul>
    <p>CAMERA permission is requested to allow users to upload their profile image using phone&rsquo;s camera.</p>
    <p>READ_CONTACTS permission is requested to allow users to invite their other friends to use the app from their
        Phone
        Contacts.</p>
    ...
    <p>We want to inform you that whenever you use our Service, in a case of an error in the app we collect data and
        ...
        information
        such as your device Internet Protocol (&ldquo;IP&rdquo;) address, device name, operating system version,
        the
    ...
    <p>This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party code
        and
        libraries that use &ldquo;cookies&rdquo; to collect information and improve their services. You have the
        option
    ...
    <p>We want to inform users of this Service that these third parties have access to your Personal Information.
        The reason
        is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or
        use the
    ...
    <p>These Services do not address anyone under the age of 13. We do not knowingly collect personally identifiable
        ...
        personal
        information, we immediately delete this from our servers. If you are a parent or guardian and you are
        aware that
